...
The Facebook Tap will use an access token generated by the OAuth process. Additionally you will need:
  ...
  **skip_adcreative_ids** - (optional) You can add a dictionary with AdCreative ids as keys and a list of fields to be excluded from GET request as values in order to resolve the issue of FacebookRequestError with error_subcode '2446289' (Ad Creative Is Incomplete).
